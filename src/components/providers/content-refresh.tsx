...
export function ContentRefresh({ initialRevision, section = "hero" }: { initialRevision: string | null; section?: "hero" | "about" | "capabilities" | "experience" | "projects" | "skills" | "education" | "contact" | "footer" | "header" }) {
